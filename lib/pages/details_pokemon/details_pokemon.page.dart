                ...
                children: [
                  Container(
                    ...
                    child: Chip(
                      ...
                      label: Text('Mystic', style: TextStyle(color: $ghost)),
                  ...
                  Expanded(
                    child: SizedBox(
                      ...
                      child: TabBarView(
                        ...
                        children: [About(), Kombat(), Variants(), Evolutions()],
                      ),
                    ),
                  ),
                ],
              ...
              child: Row(
                ...
                children: [
                  Chip(
                    ...
                    color: WidgetStatePropertyAll($ghost),
                  ...
                  Chip(
                    ...
                    color: WidgetStatePropertyAll($fairy),
                    label: Text('Fairy', style: TextStyle(color: $white)),
                    backgroundColor: $secondary,
                  ),
                ],
              ),
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child: Chip(
                                ...
                                color: WidgetStatePropertyAll($dragon),
                                avatar: Container(
                                  decoration: BoxDecoration(
                                    shape: BoxShape.circle,
                                    border: Border.all(
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child: Chip(
                                ...
                                color: WidgetStatePropertyAll($ice),
                                avatar: Container(
                                  decoration: BoxDecoration(
                                    shape: BoxShape.circle,
                                    border: Border.all(
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child: Chip(
                                ...
                                color: WidgetStatePropertyAll($grass),
                                avatar: Container(
                                  decoration: BoxDecoration(
                                    shape: BoxShape.circle,
                                    border: Border.all(
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child: Chip(
                                ...
                                color: WidgetStatePropertyAll($fighting),
                                avatar: Container(
                                  decoration: BoxDecoration(
                                    shape: BoxShape.circle,
                                    border: Border.all(
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child: Chip(
                                ...
                                color: WidgetStatePropertyAll($electric),
                                avatar: Container(
                                  decoration: BoxDecoration(
                                    shape: BoxShape.circle,
                                    border: Border.all(
                ...
                Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Transform.rotate(
                          angle: 90 * 3.14 / 180, // 180 grados en radianes
